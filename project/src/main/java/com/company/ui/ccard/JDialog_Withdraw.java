...
public class JDialog_Withdraw extends JDialog
{
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		Account account = creditCardAccountService.getAccountByName(name);
		creditCardAccountService.withdraw(account.getAccountNumber(),Double.parseDouble(JTextField_AMT.getText()),"Withdraw");
		dispose();
	}
