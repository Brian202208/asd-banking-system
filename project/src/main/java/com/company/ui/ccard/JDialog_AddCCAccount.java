...
public class JDialog_AddCCAccount extends javax.swing.JDialog
{
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
	   ...
	   CreditCardAccount creditCardAccount =(CreditCardAccount) accountFactory.createAccount(AccountType.CREDIT,parentframe.ccnumber,customer);
       ...
       if (JRadioButton_Gold.isSelected()){
		   ...
		   creditCardAccount.setStrategy(new GoldCardStrategy());
	   }
           else{
